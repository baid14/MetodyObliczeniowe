...
{
	A[0][0] = 1.0 + eps; A[0][1] = 1.0; A[0][2] = 1.0; A[0][3] = 1.0;
	A[1][0] = 1.0; A[1][1] = 1.0 + eps; A[1][2] = 1.0; A[1][3] = 1.0;
	A[2][0] = 1.0; A[2][1] = 1.0; A[2][2] = 1.0 + eps; A[2][3] = 1.0;
	A[3][0] = 1.0; A[3][1] = 1.0; A[3][2] = 1.0; A[3][3] = 1.0 + eps;

	b[0] = 6.0 + eps; b[1] = 6.0 + 2 * eps; b[2] = 6.0 + 2 * eps; b[3] = 6.0 + eps;
}
